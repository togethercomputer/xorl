...
#   COMPILE=0|1 FULLGRAPH=0|1 RESHARD=0|1 GRADCKPT=0|1 S=<seqlen> STEPS=<n> GPUS=<n>
...
# expandable_segments keeps the capture pool's steady reserved ~= eager (see ../NOTES.md);
# override by exporting PYTORCH_CUDA_ALLOC_CONF before invoking.
