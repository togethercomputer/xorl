...
# glm5 is carried by a sibling PR; skip this module if it isn't present yet.
pytest.importorskip("xorl.models.transformers.glm5.configuration_glm5")

from xorl.models.transformers.glm5.configuration_glm5 import Glm5Config  # noqa: E402
from xorl.utils.count_flops import XorlFlopsCounter  # noqa: E402
