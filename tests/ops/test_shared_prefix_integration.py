...
# The shared-prefix attention backend reaches for FA3, which is not shipped for the
# CUDA 13 / FA4 profile this tree pins. Same guard as test_shared_prefix_attention.
