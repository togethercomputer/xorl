...
def test_exact_contract_family_classification():
    ...
    assert (
        exact_contract_family(SimpleNamespace(_qwen35_exact_contract=True, model_type="qwen3_5_moe"))
        == "qwen3_5_moe"
    )
    assert (
        exact_contract_family(SimpleNamespace(_qwen35_exact_contract=True, num_experts=256)) == "qwen3_5_moe"
    )
