...
<p align="center">
  <a href="https://togethercomputer.github.io/xorl-internal/getting-started/installation/">🚀 Installation</a> ·
  <a href="https://togethercomputer.github.io/xorl-internal/getting-started/quickstart/">⚡ Quick Start</a> ·
  <a href="https://togethercomputer.github.io/xorl-internal">📚 Documentation</a>
</p>
...
**Fine-tuning methods** — full weights, [LoRA](https://togethercomputer.github.io/xorl-internal/adapters/lora/), and [QLoRA](https://togethercomputer.github.io/xorl-internal/adapters/qlora/) (int4/nvfp4/block_fp8), all FSDP2-compatible.
...
See the [quick start guide](https://togethercomputer.github.io/xorl-internal/getting-started/quickstart/) for more examples including MoE, server training, and LoRA.
...
| Topic | Link |
|---|---|
| Parallelism | [Overview](https://togethercomputer.github.io/xorl-internal/parallelism/overview/) |
| MoE & DeepEP | [MoE docs](https://togethercomputer.github.io/xorl-internal/moe/overview/) |
| LoRA / QLoRA | [Adapters](https://togethercomputer.github.io/xorl-internal/adapters/lora/) |
| Server training | [Server docs](https://togethercomputer.github.io/xorl-internal/server-training/overview/) |
| Config reference | [Local](https://togethercomputer.github.io/xorl-internal/config-reference/local/) · [Server](https://togethercomputer.github.io/xorl-internal/config-reference/server/) |
...
Models are loaded directly from HuggingFace checkpoints — no preprocessing needed. See the [supported models](https://togethercomputer.github.io/xorl-internal/models/) page for details.
