...
class ParallelPlan:
    ...
    def validate(self) -> None:
        ...
        if self.role is ParallelRole.TRAINER:
            ...
            admitted = {
                (16, 2, 1, 1, 8, 8, 1): ((0, 38), (38, 78)),
                (16, 1, 1, 2, 8, 8, 1): ((0, 78),),
                (16, 1, 1, 1, 16, 16, 1): ((0, 78),),
                (32, 1, 1, 4, 8, 8, 1): ((0, 78),),
                (32, 1, 1, 2, 16, 16, 1): ((0, 78),),
            }
    ...
    def glm52_trainer(
        ...
        *,
        ...
        pipeline_layer_ranges = ((0, 38), (38, 78)) if pp_size == 2 else ((0, 78),)
        return cls(
...
class CanonicalMoEReceipt:
    ...
    local_partial_policy: str
    engagement_key: str
    transport: CanonicalMoETransport = CanonicalMoETransport.DENSE_V1
    ...
    def as_dict(self) -> dict[str, Any]:
        return {
            ...
            "local_partial_policy": self.local_partial_policy,
            "engagement_key": self.engagement_key,
...
def _canonical_moe_reduce(
    ...
    *,
    ...
    receipt = CanonicalMoEReceipt(
        ...
        capacity=contribution.metadata.capacity,
        valid_rows=contribution.metadata.valid_rows,
        chunk_rows=effective_chunk_rows,
        graph_mode=graph_mode,
        local_partial_policy=contribution.local_partial_policy,
...
def canonical_moe_reduce_cp_sharded_v3(
    ...
    *,
    ...
    receipt = CanonicalMoEReceipt(
        contract_version=CANONICAL_MOE_CP_SHARDED_TRANSPORT_VERSION,
        plan_hash=plan.digest,
        distribution=OutputDistribution.CONSUMER_SHARDED,
        capacity=local_capacity,
        valid_rows=valid_rows,
        chunk_rows=local_capacity,
        graph_mode=graph_mode,
        local_partial_policy=contribution.local_partial_policy,
        engagement_key=engagement_key,
        transport=CanonicalMoETransport.CP_SHARDED_V3,
        source_capacity=contribution.metadata.capacity,
    )
