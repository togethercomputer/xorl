...
def qarl_sync_quantization_config(
    ...
    """
    # Imported lazily: quantization_config lives in xorl.server.weight_sync (a sibling
    # PR), and importing it at module top would create a circular dependency with the
    # weight-sync handler, which imports xorl.qarl.
    from xorl.server.weight_sync.quantization_config import (  # noqa: PLC0415
