"""Local copy of activation functions.

Copied from ``transformers.activations`` to avoid breakage across transformers
major versions.  The ``@use_kernel_forward_from_hub`` decorator is stripped
since it is an optional optimisation provided by the HF hub.
"""
...
def _is_torchdynamo_compiling():
    """Check if torch dynamo is currently compiling."""
    try:
...
class ReLUSquaredActivation(nn.Module):
    """
    Applies the relu^2 activation introduced in https://arxiv.org/abs/2109.08668
    """
