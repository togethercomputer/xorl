...
def grouped_load_weights(
    ...
    *,
    ...
    expected_parameter_count = len(parameter_names_to_load)
    expected_persistent_buffer_count = len(persistent_buffer_names_to_load)
    ...
    return {
        "schema_version": "grouped_weight_load_receipt_v2",
        "rank": global_rank,
        "world_size": dist.get_world_size(),
        ...
        "prefetch_count": prefetch_count,
        "dense_group_ranks": list(dense_ranks),
        "dense_source_rank": dense_src,
        "expert_fanout_ranks": list(fanout_ranks),
        "expert_source_rank": fanout_src,
        "is_dense_reader": is_dense_leader,
        "is_expert_reader": is_group_leader,
        "expected_parameter_count": expected_parameter_count,
        "loaded_parameter_count": len(loaded_parameter_names),
        "missing_parameter_names": sorted(parameter_names_to_load),
        "unexpected_parameter_names": sorted(unexpected_parameter_names),
        "duplicate_parameter_names": sorted(duplicate_parameter_names),
        "expected_persistent_buffer_count": expected_persistent_buffer_count,
        "loaded_persistent_buffer_count": len(loaded_persistent_buffer_names),
        "missing_persistent_buffer_names": sorted(persistent_buffer_names_to_load),
        "duplicate_persistent_buffer_names": sorted(duplicate_persistent_buffer_names),
        "non_persistent_buffer_count": len(non_persistent_buffer_names),
        "expected_skip_key_count": len(_expected_skip_keys),
    }
