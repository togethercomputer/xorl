...
@torch.library.register_fake("xorl_quack::gemm_rms_out")
...
@torch.library.register_fake("xorl_quack::gemm_norm_act_out")
...
@torch.library.custom_op(
    "xorl_quack::gemm_norm_gated_out",
    mutates_args=("preact_out", "postact_out"),
    device_types="cuda",
...
@torch.library.register_fake("xorl_quack::gemm_norm_gated_out")
