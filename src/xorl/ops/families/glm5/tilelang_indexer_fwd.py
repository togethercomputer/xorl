# ruff: noqa
# Vendored verbatim from https://github.com/tile-ai/tilelang/blob/4956b5835fa554af6c03d4a6289cad44bf310869/examples/deepseek_v32/fp8_lighting_indexer.py
...
def indexer_fwd_interface(q, kv, weights, cu_seqlen_ks, cu_seqlen_ke, clean_logits=True):
    ...
    # block_N=128, threads=256 is 39% faster than upstream's defaults
    # (block_N=256, threads=512) on GLM-5.1 shape (S=2048, S_kv=32768,
    # heads=32, dim=128): 1.12 ms vs 1.82 ms on H100. block_N=512 fails
    # with a TMA descriptor error in tilelang 0.1.9.
