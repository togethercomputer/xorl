...
TABLE = {
    ("torch.bfloat16", 3840, 3840): (
        (16, {"BLOCK_SIZE_M": 16, "BLOCK_SIZE_N": 64, "GROUP_SIZE_M": 8, "num_stages": 5, "num_warps": 4}),
        (256, {"BLOCK_SIZE_M": 64, "BLOCK_SIZE_N": 32, "GROUP_SIZE_M": 8, "num_stages": 5, "num_warps": 4}),
        (None, {"BLOCK_SIZE_M": 128, "BLOCK_SIZE_N": 256, "GROUP_SIZE_M": 8, "num_stages": 3, "num_warps": 8}),
    ),
    ("torch.bfloat16", 3840, 5376): (
        (16, {"BLOCK_SIZE_M": 16, "BLOCK_SIZE_N": 64, "GROUP_SIZE_M": 1, "num_stages": 5, "num_warps": 4}),
        (256, {"BLOCK_SIZE_M": 64, "BLOCK_SIZE_N": 64, "GROUP_SIZE_M": 1, "num_stages": 5, "num_warps": 4}),
    ...
    ("torch.bfloat16", 3840, 11520): (
        (16, {"BLOCK_SIZE_M": 16, "BLOCK_SIZE_N": 128, "GROUP_SIZE_M": 1, "num_stages": 5, "num_warps": 4}),
        (256, {"BLOCK_SIZE_M": 64, "BLOCK_SIZE_N": 128, "GROUP_SIZE_M": 8, "num_stages": 5, "num_warps": 4}),
        (None, {"BLOCK_SIZE_M": 128, "BLOCK_SIZE_N": 256, "GROUP_SIZE_M": 8, "num_stages": 3, "num_warps": 8}),
    ),
