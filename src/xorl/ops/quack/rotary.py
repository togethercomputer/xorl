...
@torch.library.custom_op(
    "xorl_quack::_rotary_fwd_inplace",
    mutates_args=("x",),
    device_types="cuda",
...
@torch.library.custom_op(
    "xorl_quack::_rotary_inplace_bwd",
    mutates_args=(),
    device_types="cuda",
...
@torch.library.custom_op(
    "xorl_quack::_rotary_qkv_inplace",
    mutates_args=("qkv",),
    device_types="cuda",
...
@torch.library.custom_op(
    "xorl_quack::_rotary_qkv_inplace_bwd",
    mutates_args=(),
    device_types="cuda",
