...
# seq_lens_cpu routes causal_conv1d_fn to this Triton kernel, not the sgl_kernel
# CUDA op, which is NOT bitwise-equal to it). Kernel body unmodified except ruff
# re-wrapping, so trainer conv bits match serving exactly; verified bitwise across
# trainer/serving venvs (triton 3.6.0/torch 2.10 == triton 3.5.1/torch 2.9.1).
