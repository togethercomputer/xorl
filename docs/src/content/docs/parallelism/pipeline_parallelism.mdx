...
| File | Description |
|---|---|
| [`src/xorl/distributed/pipeline_parallel.py`](https://github.com/togethercomputer/xorl/blob/main/src/xorl/distributed/pipeline_parallel.py) | Stage construction, 1F1B/GPipe schedule, `_pp_forward`, `build_pp_stage` |
