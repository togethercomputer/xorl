...
| File | Description |
|---|---|
| [`src/xorl/distributed/torch_parallelize.py`](https://github.com/togethercomputer/xorl-internal/blob/main/src/xorl/distributed/torch_parallelize.py) | `build_parallelize_model`, TP + FSDP2 ordering, `_build_tp_plan` |
| [`src/xorl/distributed/parallel_state.py`](https://github.com/togethercomputer/xorl-internal/blob/main/src/xorl/distributed/parallel_state.py) | `tp_mesh`, `tp_group`, device mesh construction |
| [`src/xorl/models/transformers/qwen3/parallelize.py`](https://github.com/togethercomputer/xorl-internal/blob/main/src/xorl/models/transformers/qwen3/parallelize.py) | Qwen3 TP plan (`ColwiseParallel`, `RowwiseParallel` assignments) |
