...
By default (`ep_outside=False`), the rank assignment within each `[ep_size, ep_fsdp_size]`
...
| File | Description |
|---|---|
| [`src/xorl/distributed/parallel_state.py`](https://github.com/togethercomputer/xorl-internal/blob/main/src/xorl/distributed/parallel_state.py) | EP mesh construction (`ep_mesh`, `ep_fsdp_mesh`, `ep_group`) |
| [`src/xorl/models/layers/moe/`](https://github.com/togethercomputer/xorl-internal/blob/main/src/xorl/models/layers/moe/) | `MoEBlock`, `TopKRouter`, expert weight tensors, AllToAll and DeepEP dispatch |
