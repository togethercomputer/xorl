...
| File | Description |
|---|---|
| [`src/xorl/server/weight_sync/handler.py`](https://github.com/togethercomputer/xorl-internal/blob/main/src/xorl/server/weight_sync/handler.py) | `WeightSyncHandler` — orchestrates the full sync pipeline |
| [`src/xorl/server/weight_sync/backends/`](https://github.com/togethercomputer/xorl-internal/blob/main/src/xorl/server/weight_sync/backends/) | Transport backend implementations |
