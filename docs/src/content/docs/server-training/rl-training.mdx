...
Full PPO-style clipped policy gradient loss ([`src/xorl/ops/loss/policy_loss.py`](https://github.com/togethercomputer/xorl/blob/main/src/xorl/ops/loss/policy_loss.py)):
...
Simpler importance-sampling loss for GRPO-style training ([`src/xorl/ops/loss/importance_sampling_loss.py`](https://github.com/togethercomputer/xorl/blob/main/src/xorl/ops/loss/importance_sampling_loss.py)):
