...
|---|---|---|
| `tests/checkpoint/` | Checkpoint process groups and EP mesh handling | `test_checkpointer_process_group.py`, `test_ep_checkpoint_mesh.py` |
| `tests/data/` | Dataset preparation, packing, collators, dataloaders | `test_data_loader.py`, `collators/test_collate_pipeline.py` |
...
| `tests/utils/` | FLOP accounting, timing, and teacher caches | `test_count_flops.py`, `test_manual_cuda_timing.py` |
