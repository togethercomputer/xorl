...
| File | Description |
|---|---|
| [`src/xorl/cli/train.py`](https://github.com/togethercomputer/xorl-internal/blob/main/src/xorl/cli/train.py) | CLI entry point (`xorl.cli.train`) |
| [`src/xorl/data/data_loader.py`](https://github.com/togethercomputer/xorl-internal/blob/main/src/xorl/data/data_loader.py) | DataLoader and MicroBatchCollator |
| [`src/xorl/data/prepare/`](https://github.com/togethercomputer/xorl-internal/blob/main/src/xorl/data/prepare/) | Dataset preparation and sample packing |
