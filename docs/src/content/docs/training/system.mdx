...
[`src/xorl/trainers/trainer.py`](https://github.com/togethercomputer/xorl/blob/main/src/xorl/trainers/trainer.py)
...
| 3 | `_parallelize()` | Apply TP plan, FSDP2/EP mesh, PP split; load weights with grouped fanout |
...
See [`src/xorl/distributed/gradient_accumulate_loss.py`](https://github.com/togethercomputer/xorl/blob/main/src/xorl/distributed/gradient_accumulate_loss.py).
...
[`src/xorl/data/data_loader.py`](https://github.com/togethercomputer/xorl/blob/main/src/xorl/data/data_loader.py)
...
Packed bins are cached to disk (keyed by a hash of the packing config) so subsequent runs skip re-packing. See [`src/xorl/data/prepare/packing.py`](https://github.com/togethercomputer/xorl/blob/main/src/xorl/data/prepare/packing.py).

---

## Model Parallelization

[`src/xorl/distributed/torch_parallelize.py`](https://github.com/togethercomputer/xorl/blob/main/src/xorl/distributed/torch_parallelize.py)
...
7. Weight loading    — grouped fanout (or all_ranks read independently)
```
...
| File | Description |
|---|---|
| [`src/xorl/trainers/trainer.py`](https://github.com/togethercomputer/xorl/blob/main/src/xorl/trainers/trainer.py) | `Trainer` class — full lifecycle, `train_step`, `_forward_backward`, `_forward_backward_pp` |
| [`src/xorl/trainers/training_utils.py`](https://github.com/togethercomputer/xorl/blob/main/src/xorl/trainers/training_utils.py) | `_count_valid_tokens`, `_sync_sp_gradients`, `_clip_and_step`, `_reduce_metrics` |
| [`src/xorl/data/data_loader.py`](https://github.com/togethercomputer/xorl/blob/main/src/xorl/data/data_loader.py) | `DataLoaderBuilder`, `MicroBatchCollator` |
| [`src/xorl/data/collators/`](https://github.com/togethercomputer/xorl/blob/main/src/xorl/data/collators/) | `ToTensorCollator`, `PackingConcatCollator`, `TextSequenceShardCollator`, etc. |
| [`src/xorl/data/collators/sequence_shard_collator.py`](https://github.com/togethercomputer/xorl/blob/main/src/xorl/data/collators/sequence_shard_collator.py) | `zigzag_reorder_packed_sequence()`, `TextSequenceShardCollator` |
| [`src/xorl/distributed/torch_parallelize.py`](https://github.com/togethercomputer/xorl/blob/main/src/xorl/distributed/torch_parallelize.py) | `parallelize_model_fsdp2()`, `_build_tp_plan()`, FSDP2 wrapping order |
| [`src/xorl/distributed/gradient_accumulate_loss.py`](https://github.com/togethercomputer/xorl/blob/main/src/xorl/distributed/gradient_accumulate_loss.py) | `GradientAccumulateLoss` — token-normalized gradient scaling |
