"""Opt-in certification against an official GLM-5.2 checkpoint inventory.

Run explicitly with ``pytest certification/glm52/test_official_fp8_inventory.py``
after setting ``XORL_GLM52_OFFICIAL_MODEL_PATH``.
"""
